...
- Clone the repository by running `git clone git@github.com:NicoBuchhalter/memory-test.git`
- Go to the project root by running `cd memory-test`
...
```bash
  ...
  CREATE ROLE "memory-test" LOGIN CREATEDB PASSWORD 'memory-test';
```
...
This project is maintained by [Nicolás Buchhalter](https://github.com/NicoBuchhalter).
